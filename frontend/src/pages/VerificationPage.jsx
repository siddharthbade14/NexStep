    ...
    <div className="space-y-6 py-2 sm:py-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="rounded-2xl overflow-hidden bg-slate-950 border border-slate-800 shadow-2xl flex flex-col transition-all">
            ...
            <div className="px-4 py-3 bg-slate-900/90 border-b border-slate-800 flex flex-wrap items-center justify-between gap-3 text-xs">
              ...
              <div className="flex items-center gap-3">
                ...
                {/* Active Tab */}
                <div className="flex items-center gap-2 px-2.5 py-1 rounded-lg bg-slate-800/80 border border-slate-700/60 text-slate-200 font-mono font-semibold text-[11px]">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-2.5 py-1 text-[11px] font-semibold bg-amber-400/15 text-amber-300 hover:bg-amber-400/25 rounded-lg border border-amber-400/30 transition-all hover:-translate-y-0.5 active:translate-y-0 shadow-xs flex items-center gap-1"
                >
                ...
                <button
                  ...
                  className="px-2.5 py-1 text-[11px] font-semibold bg-rose-400/15 text-rose-300 hover:bg-rose-400/25 rounded-lg border border-rose-400/30 transition-all hover:-translate-y-0.5 active:translate-y-0 shadow-xs flex items-center gap-1"
                >
            ...
            <div className="px-4 py-3 bg-slate-900/95 border-t border-slate-800 flex items-center justify-between">
              <span className="text-[11px] text-slate-400 flex items-center gap-1.5">
                ...
                Instant sandboxed verification
              </span>
              ...
              <Button
                ...
                loading={running}
                iconLeft={Play}
                className="text-xs font-bold text-slate-950 shadow-accent px-5 hover:-translate-y-0.5 active:translate-y-0 transition-transform"
              >
                Run & Verify Code
              </Button>
            </div>
